 ...
 * 
 * No es una implementaci�n particularmente eficiente (ser�a m�s eficiente haber
 ...
 * 
 * Esta clase tambi�n incluye mecanismos de persistencia sobre archivos CSV
 */
public class Top10
{
	// ********************************
	 ...
	 */
	private static PriorityQueue<RegistroTop10> registros;
	 ...
	 * entrar o no al top-10 (conocer el �ltimo elementos de una Cola de Prioridades
	 * es O(n) )
	 */
	...
	public Top10()
	{
		...
		// comparador para Registros. Este comparador se usar� cada vez
		// que se agregue un elemento a la cola y se basar� en los puntos.
		// El comparador se implementa como una clase interna an�nima porque
		// no se usar� en ninguna otra parte del programa y no tiene sentido
		// reutilizarla.
	 ...
	 * @return True si el puntaje deber�a estar en el top10
	 */
	...
	/**
	 * Agrega un nuevo registro al top10, en la posici�n correcta de acuerdo a la
	 * cantidad de puntos.
	 * 
	...
	public void agregarRegistro(String nombre, int puntaje)
	{
		...
		// Si hay m�s de 10 registros en el top 10 despu�s de agregar el nuevo, debe
		// eliminarse el peor.
		// En una cola de prioridades no se pueden eliminar elementos de una posici�n
		// particular, as� que es necesario sacar los 10 mejores registros a una lista
	 ...
	 * modificar
	 * 
	 * @return Los registros del top 10, vistos como una colecci�n.
	 */
	public static Collection<RegistroTop10> darRegistros()
	{
		return registros;
	}
	 ...
	 * siguiente formato:
	 * 
	 * - En cada l�nea aparece un registro
	 * 
	 * - Cada registro tiene el nombre y los puntos separados por el caracter ';'
	 * 
	 * @param archivo El archivo donde se debe almacenar la informaci�n
	 * @throws FileNotFoundException        Esta excepci�n se lanza si hay problemas
	 *                                      creando el archivo
	 * @throws UnsupportedEncodingException Esta excepci�n se lanza si por alg�n
	 *                                      motivo no puede usarse el encoding utf-8
	 *                                      para guardar la informaci�n dentro del
	 *                                      archivo.
	 */
	...
	/**
	 * Carga la informaci�n de los records a partir de un archivo de texto que debe
	 ...
	 * - Cada registro tiene el nombre y los puntos separados por el caracter ';'
	 * 
	 * @param archivo El archivo donde se encuentra almacenada la informaci�n de los
